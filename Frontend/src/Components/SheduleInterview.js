...
function ScheduleInterview(){
    const [formData, setFormData] = useState({
      ...
      const handleSubmit = async(e) => {
        ...
        notificationData.title = `Interview Scheduled for ${formData.role} Role`;
        notificationData.message = `Your Interview for ${job.role} has been scheduled. Check interview scetion  `;
